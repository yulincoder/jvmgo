...
func newConstantInfo(tag uint8, cp ConstantPool) ConstantInfo {
	switch tag {
		...
		case CONSTANT_Fieldref: return &ConstantFieldInfo{ConstantMemberrefInfo{cp: cp}}
		case CONSTANT_Methodref: return &ConstantMemberrefInfo{ConstantMemberrefInfo{cp: cp}}
